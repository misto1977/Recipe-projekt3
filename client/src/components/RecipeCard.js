    ...
    return (
      <div className="col-xl-4 col-lg-6 col-md-6">
        <div className="box_grid">
          <figure>
            <Link to={`/recipe/${this.props.id}/${this.props.people}`}><img src={"images/recipes/" + this.props.data.urlToImg} className="img-fluid" alt={this.props.data.name} width="800" height="533" /><div className="read_more"><span>Read more</span></div></Link>
